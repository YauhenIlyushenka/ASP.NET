...
using Pcf.Administration.Integration.RabbitMQ.Consumers;
using Pcf.Administration.WebHost.Infrastructure.RabbitMQ.Model;
using Pcf.MassTransitContracts;
using RabbitMQ.Client;
using System;

namespace Pcf.Administration.WebHost.Infrastructure.RabbitMQ
{
	public static class MassTransitConfigurator
	{
		public const string AdministrationQueueName = "NotifyAboutAppliedPromocodeQueue";
		public const string AdministrationDeadLetterQueueName = "DLQNotifyAboutAppliedPromocode";

		public static void ConfigureMassTransit(this IServiceCollection services, RabbitMQSettings rabbitMQSettings)
		{
			services.AddMassTransit(x =>
			{
				x.AddConsumer<ApplyingPromocodeConsumer>();
				...
				x.UsingRabbitMq((context, cfg) =>
				{
					...
					cfg.ReceiveEndpoint(AdministrationQueueName, e =>
					{
						e.ConfigureConsumer<ApplyingPromocodeConsumer>(context);
						...
						e.BindDeadLetterQueue(
							...
							AdministrationDeadLetterQueueName,
							dlq =>
							{
