...
namespace PromoCodeFactory.UnitTests.BusinessLogic
{
	public class PartnerServiceTests
	{
		...
		[Fact]
		public async Task CancelPartnerPromoCodeLimitAsync_VerifyUpdateRepositoryCall_UpdateCalled()
		{
			// Arrange
			var partnerId = Guid.Parse("def47943-7aaf-44a1-ae21-05aa4948b165");
			...
			// Assert
			_partnerRepositoryMock.Verify(s => s.Update(It.IsAny<Partner>()), Times.Once);
		}
